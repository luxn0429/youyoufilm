...
public abstract class ConditionCache implements IMemcachedCache, Observer,Serializable {
	private static final Log Logger = LogFactory.getLog(ConditionCache.class);
	////客户端
	...
	public ConditionCache(String name,MemCachedClient client,Integer statisticsInterval){
		this.client = client;
		this.name = name;
